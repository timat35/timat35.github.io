	...
	function changeArticleMaro(article, mobil) {
		...
		if (article == 'portemonnaie') {
			...
			source[1] = "/media/photo-maroquinerie/portemonnaie-multiple.jpg";
			source[2] = "/media/photo-maroquinerie/portemonnaie-jaune-rouge-profil.jpg";
			source[3] = "/media/photo-maroquinerie/portemonnaie-jaune-rouge-interieur.jpg";
			var	articleTitle= "Porte-monnaie",
			...
			source[1] = "/media/photo-maroquinerie/porte-monnaie-3-poche-multiple.jpg";
			source[2] = "/media/photo-maroquinerie/porte-monnaie-3-poche.jpg";
			source[3] = "/media/photo-maroquinerie/porte-monnaie-3-poche-ouvert.jpg";
			...
			source[1] = "/media/photo-maroquinerie/porte-monnaie-demi-lune-multiple.jpg";
			source[2] = "/media/photo-maroquinerie/porte-monnaie-demi-lune.jpg";
			source[3] = "/media/photo-maroquinerie/porte-monnaie-demi-lune-ouvert-2.jpg";
			var	articleTitle= "Porte-monnaie Demi-lune",
		...
		$("#porteMonnaie_btnCouleur").removeClass("noDisplay");
			...
			source[1] = "/media/photo-maroquinerie/portefeuille-multiple-couleur.jpg";
			source[2] = "/media/photo-maroquinerie/portefeuille-rouge-mauve.jpg";
			...
			source[6] = "/media/photo-maroquinerie/portefeuille-bleu.jpg";
			source[7] = "/media/photo-maroquinerie/portefeuille-marron.jpg";
			source[8] = "/media/photo-maroquinerie/portefeuille-vert.jpg";
			source[9] = "/media/photo-maroquinerie/portefeuille-noir.jpg";
			source[10] = "/media/photo-maroquinerie/portefeuille-rouge.jpg";
			source[11] = "/media/photo-maroquinerie/portefeuille-marron-fonce.jpg";
			...
			source[1] = "/media/photo-maroquinerie/portechequier-bleue-marine.jpg";
			...
			source[1] = "/media/photo-maroquinerie/etui-lunette-jaune-face.jpg";
			source[2] = "/media/photo-maroquinerie/etui-lunette-jaune-bleu.jpg";
			source[3] = "/media/photo-maroquinerie/etui-lunette-jaune-doublure.jpg";
	...
	function changeArticleSac(article, mobil) {
		...
		var $body = $( 'body' ),
			...
			$body.addClass( 'animating' );
			$body.addClass( 'up anim5' );
			
		$('#toggle-menu').removeClass('noDisplay')

		$content.on( transitionEnd, function() {
			$body
			.removeClass( 'animating  up anim5' )
			.removeClass( 'menu-visible anim5' );
		$content.off( transitionEnd );
			});
			
		setTimeout( function(){
				 $body.removeClass( 'animating down up anim5' );
				 $body.removeClass( 'menu-visible anim5' );
				}, 300);
