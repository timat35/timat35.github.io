	...
	<div class="d-flex justify-content-center">
		<div class = "row pad40 mt-3">
			...
			<div class="col-6 mat-col-1450-6 div_index_img">
				<div class="row">
					<img src="img/acceuil/index-restauration1.jpg" alt="tet-en-lair acceuil"  class= "col-6 row_padlr img_max"/>
					<img src="img/acceuil/index-restauration2.jpg" alt="tet-en-lair acceuil"  class= "col-6 row_padlr img_max"/>
				</div>
			</div>
		</div>
	</div>
